...
exports.isOwner = (ctx, obj) => {
    ...
    const isOwner = obj.selfOwner ? ctx._client.user.id.split(":")[0] === id || global.owner.co.includes(id) || ctx._client.user.id.split(":")[0] === id : global.owner.co.includes(id) || ctx._client.user.id.split(":")[0] === id;
    return isOwner ? 1 : 0;
};
