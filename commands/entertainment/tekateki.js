...
module.exports = {
    ...
    code: async (ctx) => {
        ...
        try {
            const apiUrl = global.tools.api.createUrl("https://raw.githubusercontent.com", "/BochilTeam/database/master/games/tekateki.json", {});
            const response = await axios.get(apiUrl);
            const data = global.tools.general.getRandomElement(response.data);
            const coin = 5;
            const timeout = 60000;
            const senderNumber = ctx.sender.jid.split("@");
