...
module.exports = {
    ...
    code: async (ctx) => {
        ...
        if (msgType !== MessageType.stickerMessage || !(await ctx.quoted.media.toBuffer())) return ctx.reply(quote(`📌 ${await global.tools.msg.translate("Berikan atau balas media berupa sticker!", userLanguage)}`));
